...
r"""Convert existing images to TFRecords (https://www.tensorflow.org/programmers_guide/datasets).
...
def run(args):
  ...
  load_and_save_as_tf_records(src_bucket, args.src_folder, dst_bucket,
                              args.dst_file)
