...
func (f *ComputeFirewall) ImportID(runner runner.Runner) (string, error) {
...
// ImportID returns the ID to use for terraform imports.
func (i *ComputeImage) ImportID(runner runner.Runner) (string, error) {
...
// ImportID returns the ID to use for terraform imports.
func (i *ComputeInstance) ImportID(runner runner.Runner) (string, error) {
