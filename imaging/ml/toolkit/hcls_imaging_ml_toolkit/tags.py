...
PRESENTATION_INTENT_TYPE = DicomTag(number='00080068', vr='CS')
...
BIOPSY_TARGET_SEQUENCE = DicomTag(number='00182041', vr='SQ')
...
BREAST_IMPLANT_PRESENT = DicomTag(number='00281300', vr='CS')
PARTIAL_VIEW = DicomTag(number='00281350', vr='CS')
