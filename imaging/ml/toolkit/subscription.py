...
class SubscriptionClient(object):
  ...
  def __init__(self,
               ...
               channel: Optional[grpc.Channel] = None) -> None:
    ...
    Args:
      ...
      credentials: Google Auth Credentials, if not set it will use the default
        credentials
      channel: grpc.Channel for initalizing SubscriberClient, if not set it will
        use the default logic in the client init.
    """
