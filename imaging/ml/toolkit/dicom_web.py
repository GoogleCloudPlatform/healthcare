...
class DicomWebClient(six.with_metaclass(abc.ABCMeta, object)):
  ...
  @abc.abstractmethod
  def StowRs(self, stow_url: Text, dcmbytes: bytes) -> None:
...
class DicomWebClientImpl(DicomWebClient):
  ...
  def QidoRs(self, qido_url: Text) -> List[Dict[Text, Any]]:
    ...
    Raises:
      UnexpectedResponseError: If the response status was not 200.
    """
  ...
  def WadoRs(self, wado_url: Text, accept_header: Text = None) -> bytes:
    ...
    Raises:
      UnexpectedResponseError: If the response status was not 200 or the number
      of parts in the multipart response is different from 1.
    """
  ...
  def StowRs(self, stow_url: Text, dcmbytes: bytes) -> None:
    ...
    Args:
      ...
      dcmbytes: Serialized DICOM instance to store.
    """
    ...
    return self._StowRs(stow_url, application_type, [part])
  ...
  def _StowRs(self, stow_url: Text, application_type: Text,
    ...
    Raises:
      UnexpectedResponseError: If StowRs response status was not 200.
    """
  ...
  def DeleteRs(self, delete_url: Text) -> None:
    ...
    Raises:
      UnexpectedResponseError: If DeleteRs response status was not 200.
    """
